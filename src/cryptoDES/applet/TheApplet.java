...
public class TheApplet extends Applet {
    ...
    */
    ...
    public void process(APDU apdu) throws ISOException {
        ...
        try { switch( buffer[ISO7816.OFFSET_INS] ) {
            ...
            case INS_DES_ECB_NOPAD_ENC: if( DES_ECB_NOPAD )
                cipherGeneric( apdu, cDES_ECB_NOPAD_enc, KeyBuilder.LENGTH_DES ); return;//chiffrer  les données venant du pc
	...
	private void testCipherGeneric( Cipher cipher, short keyLength, short nbLoops ) { // chiffrer et dechiffrer l objet avec 
		for( i = 0; i < nbLoops; i++ )
